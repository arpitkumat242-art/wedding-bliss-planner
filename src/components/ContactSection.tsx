      ...
      <div className="container mx-auto">
        ...
        <div className="grid sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
          <div className="flex flex-col items-center gap-3 bg-teal-light/30 border border-gold/20 rounded-2xl p-6 hover:border-gold/50 transition-colors text-center">
            ...
            <a href="tel:+919336480827" className="text-primary-foreground/70 text-sm font-body hover:text-gold transition-colors">+91 93364 80827</a> className="text-primary-foreground/70 text-sm font-body hover:text-gold transition-colors">+91 93364 80827</a></a>
          </div>
